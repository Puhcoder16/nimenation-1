  ...
  return (
    <section id="about" ref={ref} className="py-20">
      <motion.div
        ...
        className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center bg-gray-800/20 backdrop-blur-sm border rounded-2xl p-8 md:p-12 ${theme.sections.borders.subtle}`}
      >
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-6">
          <AboutIcon className="w-12 h-12 sm:w-10 sm:h-10 text-orange-400" />

...
const ShinyButton = ({ children, href, to, className = '' }) => {
  ...
  const content = (
    <>
      ...
      <div className="relative flex space-x-2 items-center justify-center z-10 rounded-full bg-zinc-950 py-2 px-6 ring-1 ring-white/10">
        {/* FIX: Mengganti span statis dengan children agar bisa menerima ikon dan teks */}
        {children}
      </div>

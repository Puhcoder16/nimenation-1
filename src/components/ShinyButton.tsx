...
const ShinyButton: React.FC<ShinyButtonProps> = ({ href, text, className = '' }) => {
  return (
    <a
      href={href}
      target="_blank"
    ...
    >
      <span className="absolute inset-0 overflow-hidden rounded-full">
        <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(234,88,12,0.6)_0%,rgba(234,88,12,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      </span>
